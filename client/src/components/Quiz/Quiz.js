...
class Quiz extends Component {
    ...
    <div className="quiz">
        ...
        <ul>
            <li onClick={this.handleClick} value={this.state.quiz.choice1}>{this.state.quiz.choice1}</li>
            <li onClick={this.handleClick} value={this.state.quiz.choice2}>{this.state.quiz.choice2}</li>
            <li onClick={this.handleClick} value={this.state.quiz.choice3}>{this.state.quiz.choice3}</li>
            <li onClick={this.handleClick} value={this.state.quiz.choice4}>{this.state.quiz.choice4}</li>
        </ul>
