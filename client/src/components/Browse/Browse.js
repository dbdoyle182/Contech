    ...
    return (
      <div className="browse">
        ...
        <div className="holder">
          <div className="stack">
            <div className="menu">
              <TagMenu callback={this.childFilter} />
            </div>
            <div className="menu">
              <LetterMenu callback={this.childLetter} />
            </div>
            <div>
              <button className="browse-button" onClick={this.browsingData}>
                Browse
              </button>
            </div>
          </div>
        ...
        <div className="browse-results">
          ...
          {(this.state.results === "No Results" || this.state.length === 0) && (
