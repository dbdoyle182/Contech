    ...
    {props.comments.map(comment => {
      return (
        <div className="commentContainer" key={comment._id}>
          ...
          {props.update === true && props.commentId === comment._id ? (
            <textarea
              className="editBox"
            ...
            <div className="commentBody">
              <div className="commentBar">
                {moment(comment.createdAt).format("MMMM Do YYYY  hh:mma")}{" "}
                {props.update === false &&
                  props.username === comment.authorName && (
                    <img
                      className="commentIcon"
                      onClick={() =>
                        props.updateComment(comment._id, comment.body)
                      }
          ...
          {props.username === comment.authorName && (
            <div>
              {props.update === true &&
                props.commentId === comment._id && (
                  <button
                    className="deleteComment"
                    onClick={() =>
                      props.updateComment(comment._id, props.commentEdit)
                    }
                  >
                    Done
                  </button>
